...
public class GetTrainerInfos {
    ...
    public String[] search(String SearchID) {
        if(SearchID == ""){
            ...
            try {
            String sql1 = "Select * from trainerdata Where TID = ?";
             ...
             String [] r  = {name,birth,contact,address,gender,startD,TID};
             System.arraycopy(r, 0, results, 0, 7);
             return results;

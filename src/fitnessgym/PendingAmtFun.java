 ...
 * @author TSS
 */
public class PendingAmtFun {
     Connection cnn=new DBConnection().connect();
    PreparedStatement pst;
    ResultSet res;
    ResultSetMetaData rsmd;
    String sD,eD;
    PendingAmtFun(String startD, String endD) {
        sD=startD;
        eD=endD;
        }
   ...
   public DefaultTableModel getData()
    {
        ...
        try{
            ...
            String sql="select MemberID,Name,PendingAmount,Facility "
                    + "from memberdatas where StartDate between '"+sD+"' and '"+eD+"' and "
                    + "PendingAmount!=0;";
